...
export default function TaskDetailPage() {
  ...
  const updateMut = useMutation({
    mutationFn: (payload: Partial<TaskPayload>) =>
              ...
              <Button
                ...
                onClick={() => {
                  setForm({
                    ...
                    assignedTo:
                      task.assignedToId || (task.assignedTo as any)?._id || "",
                    clientId: task.clientId || (task.client as any)?._id || "",
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            <div>
              ...
              <Badge className={cn("ml-1 text-xs", STATUS_COLOR[task.status])}>
            ...
            {task.address && (
              <div>
                ...
                <span className="ml-1">{task.address}</span>
              </div>
            )}
          ...
          <CardContent>
            {!task.images || task.images.length === 0 ? (
              ...
              <div className="grid grid-cols-2 gap-2">
                {task.images.map((src: string, i: number) => (
                  <img
                    key={i}
                    src={src}
                    alt={`Imagen ${i + 1}`}
        ...
        <DialogContent>
          ...
          >
            ...
            <Button
              ...
              className="w-full"
              disabled={
                !form.title.trim() || !form.assignedTo || updateMut.isPending
              }
            >
              {updateMut.isPending && (
                <Loader2 className="h-4 w-4 animate-spin mr-2" />
